...
CREATE TABLE IF NOT EXISTS users (
  ...
  is_deleted TINYINT(1) NOT NULL DEFAULT 0, -- trajno izbrisan (anonimiziran) - ločeno od is_active, ker se ne da povrniti
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS work_log_participants (
  ...
  user_id INT NOT NULL,
  minutes_override INT NULL, -- ročno popravljene minute za tega udeleženca; NULL = privzeto trajanje vnosa
